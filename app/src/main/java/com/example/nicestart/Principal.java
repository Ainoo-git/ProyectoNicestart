...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Asegúrate de que este ID existe en tu layout principal.xml
        ...
        // Cargar imagen con Glide en el background
        Glide.with(this)
                ...
                .into(background); // ¡IMPORTANTE! Asignar a un ImageView

        openApp(); // Llamar al método que abre la siguiente actividad
    }
